  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-4">
        <div className="grid size-[72px] shrink-0 place-items-center overflow-hidden rounded-full border border-[rgba(214,184,255,0.36)] bg-white/10 font-serif text-2xl font-semibold text-[var(--lavender)] shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_16px_34px_rgba(0,0,0,0.32)]">
          {photoUrl ? (
